...
* Enable the module and add badges at - "achievement/add/badges".
* Set your desired permissions at "admin/people/permissions".

Usage
-----
   
 * Go to /admin/structure/Achievement where you will see badges bundle.
   (structure >> Openbadging Configurations >> Badges)
 * For creating badges go to "/achievement/add/badges" and 
   create badges.(structure >> Openbadging Configurations >> ADD Achievement)
 * It connect achievement issuer by program taxonomy.
