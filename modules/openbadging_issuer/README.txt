...
* Enable the module and add issuer information at 
  achievement/add/issuer_information.
  (structure >> Openbadging Configurations >> ADD Achievement)
* Set your desired permissions at admin/people/permissions.

Usage
-----
   
 * Go to /admin/structure/Achievement you can see Issuer Information bundle.
   (structure >> Openbadging Configurations >> Issuer Information)
 * For creating badges go to (/achievement/add/issuer_information) 
...
Program:
      ...
      It is existing taxonomy field which is exist in achievement_badges. 
